                ...
                case .expanded:
                    ...
                    if(self.counter%2==0)
                    {
                        UIView.animate(withDuration: 0.4, animations: ({
                            self.cardViewController.handleicon.transform = CGAffineTransform(rotationAngle: .pi)
                        }))
                    }
                    else
                    {
                        UIView.animate(withDuration: 0.4, animations: ({
                            self.cardViewController.handleicon.transform = CGAffineTransform(rotationAngle: .pi*2)
                        }))
                    }
